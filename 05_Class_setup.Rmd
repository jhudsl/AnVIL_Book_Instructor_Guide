...
1. Enter the name of the Instructor Group (e.g., jhu-bmr2021-instructors). This will create a dropdown for the Group permissions in the box.

1. Change permissions to “Owner”
...
1. Enter the name of the Student Group. This will create a dropdown for the Group permissions in the box.
