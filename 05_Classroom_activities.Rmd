...
| Activity | Skill level | Platform   
| :-- | :-- | :-- |
| [GDSCN: SARS Galaxy on AnVIL](https://jhudatascience.org/GDSCN_Book_SARS_Galaxy_on_AnVIL) | Advanced undergraduates, Graduate students | Galaxy |
| [GDSCN: Statistics for Genomics Differential Expression](https://jhudatascience.org/GDSCN_Book_Statistics_for_Genomics_Differential_Expression) | Graduate students | RStudio |
| [GDSCN: Statistics for Genomics PCA](https://jhudatascience.org/GDSCN_Book_Statistics_for_Genomics_PCA) | Graduate students | RStudio |
| [GDSCN: Statistics for Genomics RNA-seq](https://jhudatascience.org/GDSCN_Book_Statistics_for_Genomics_RNA-seq) | Graduate students | RStudio |
| [GDSCN: Statistics for Genomics SCRNA-seq](https://jhudatascience.org/GDSCN_Book_Statistics_for_Genomics_SCRNA-seq) | Graduate students | RStudio |
| [AnVIL: Phylogenetic Techniques](https://jhudatascience.org/phylogenetic-techniques) | Advanced undergraduates, Graduate students | RStudio |
| AnVIL: Tree Thinking | Advanced undergraduates, Graduate students | RStudio |
| AnVIL: Epigenomics |  | Galaxy |
