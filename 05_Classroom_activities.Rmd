...
This chapter will help you get started with the premade class activities available through AnVIL. Here are the activities currently available:

| Activity | Skill level | Platform   | Estimated Cost per student	|
| :-- | :-- | :-- | :--|
| [GDSCN: SARS Galaxy on AnVIL](https://jhudatascience.org/GDSCN_Book_SARS_Galaxy_on_AnVIL) | Advanced undergraduates, Graduate students | Galaxy | Coming soon |
| [GDSCN: Statistics for Genomics Differential Expression](https://jhudatascience.org/GDSCN_Book_Statistics_for_Genomics_Differential_Expression) | Graduate students | RStudio | Coming soon |
| [GDSCN: Statistics for Genomics PCA](https://jhudatascience.org/GDSCN_Book_Statistics_for_Genomics_PCA) | Graduate students | RStudio | Coming soon |
| [GDSCN: Statistics for Genomics RNA-seq](https://jhudatascience.org/GDSCN_Book_Statistics_for_Genomics_RNA-seq) | Graduate students | RStudio | Coming soon |
| [GDSCN: Statistics for Genomics SCRNA-seq](https://jhudatascience.org/GDSCN_Book_Statistics_for_Genomics_SCRNA-seq) | Graduate students | RStudio | Coming soon |
| [AnVIL: Phylogenetic Techniques, full semester course](https://jhudatascience.org/phylogenetic-techniques) | Advanced undergraduates, Graduate students | RStudio | Coming soon |
| AnVIL: Phylogenetic Techniques, single activity | Advanced undergraduates, Graduate students | RStudio | Coming soon |
| AnVIL: Epigenomics |  |  | Coming soon |
