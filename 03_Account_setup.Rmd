...
AnVIL uses [Terra](https://anvil.terra.bio/) to run analyses. Terra operates on Google Cloud Platform, so students need a Google account to make sure you  can keep track of any computing costs they accrue. 

## Step 1: Have students create a Google Account

```{r, child=c("_child_create_google_account.Rmd")}

```

## Step 2: Have students sign in to Terra
...
## Step 3: Get IDs from students

It is _very important_ students share the Google account they used above with you! Otherwise, you cannot add them to class projects or Workspaces.
...
Note that your newly created Groups have Group emails associated with them. Take note of these Group emails. You will use them for granting access to your class Billing Projects and Workspaces.
