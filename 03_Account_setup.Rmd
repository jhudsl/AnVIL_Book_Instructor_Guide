...
The instructions below walk you through creating a Terra Billing Project.  If you do not need to create your own, you can proceed directly to [adding instructors to Billing Project](#add-instructors-billing-project).
...
If you want to grant a Terra Group access to Terra resources (Billing Projects or Workspaces), you will need the email address associated with the Group.  You can find this on the Group Management page:
