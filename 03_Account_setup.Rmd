...
This section covers everything needed to set up yourself and any co-instructors or TAs to work on AnVIL.  By the end of this section you and your team will be able to develop and run exercises on AnVIL and share your work with each other.

- Depending on your team and funding, you may only need to do these steps once (and then make updates on an as-needed basis for changes in team members or funding).

The section on class setup covers how to grant your students access to AnVIL.

- These steps will need to be repeated for each new offering of the course.

## What do I need to do?

You may not need to do everything in the instructor setup guide!

The guide contains instructions for setting up billing from scratch.  If your funding is being managed by a third party (such as or your department) you can skip some steps.  The table below provides guidance on which steps you will need to complete:

| Task | Self-managed Funding | 3rd-party Funding |
|:-----|:---:|:--:| 
|Create Google Account|Yes|Yes|
|Set up Google Billing|Yes|Probably No (but check with your funding manager)|
|Set up Terra Billing Projects|Yes|Probably Yes (but check with your funding manager|

The guide contains instructions for setting up Groups for collaboration with co-instructors and TAs.  If you are teaching by yourself, you can skip Creating Instructor/TA groups.
...
# Create Instructor/TA group(s) {#instructor-group}
...
- Create single Group that persists across course offerings.  This is convenient if the same people will be teaching the course multiple times; you will not have to re-share resources each time.
...
- You **will** need to manage members of your Billing Project(s), in order to add students and TAs.  This is most easily done using Terra Groups.
...
The instructions below walk you through creating a Terra Billing Project.  If you do not need to create your own, you can skip to [adding instructors to Billing Project](#add-instructors-billing-project).
...
Having separate Billing Projects is not required, but can make management a bit easier.
...
Before you or any of your team can compute on AnVIL, you must be added to a Billing Project.
...
- To add a Group, you will need the email address associated with the Group.  You can find this on the Group Management page:
