...
We generally recommend waiting until shortly before the class to add students to the Billing Project, to prevent them from starting something up early and accruing costs.  We typically have students clone the Workspace in the first few minutes of class.  This both helps ensure they won't start up their cloud environments early, and ensures they get the most up-to-date version of the Workspace.
...
When you are ready for your students to start computing, you should add the Student Group to your Billing Project.  This will enable them to clone or create Workspaces funded by the Billing Project.  Everything they do in those Workspaces will be charged to your Billing Project.
...
If your students will continue using the Workspace in a subsequent class or for homework, have them pause or delete the cloud environment so they do not accrue charges while they are not working.
