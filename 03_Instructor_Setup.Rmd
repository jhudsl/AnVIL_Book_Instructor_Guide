...
The first set of instructions below walk you through creating a Terra Billing Project.  If you do not need to create your own, you can skip down to [adding instructors to Billing Project](#add-instructors-billing-project).
...
When teaching with a team, it may make sense to add only those most comfortable with Terra and/or most involved in Terra administration Owners, and to add everyone else as Users.  This can be done by adding the Owners individually as Owners, and then adding the Instructor Group as User.
:::
...
Your team members should be free to develop and test content, funded by your Billing Project.  Checkout the *Content Preparation* section for more information about how to use or develop content on AnVIL.
